...
<html lang="en">
  ...
  <body class="dark:text-gray-200 dark:bg-slate-900">
    ...
    >
      <nav class="flex justify-between items-center max-w-6xl mx-auto px-2">
        <div class="flex gap-4 items-center">
          <div>
            <h4 class="font-bold text-xl">Ibnu.</h4>
          </div>
        </div>
        <ul class="gap-10 md:flex hidden hover:*:text-primary *:duration-200">
          ...
          <li>
            <a href="#about-skills">About Us</a>
          </li>
          <li>
      ...
      <div class="pt-20 grid md:grid-cols-2 h-full items-center max-w-4xl justify-between">
        ...
        <div class="text-center md:text-left px-6">
          ...
          <h1 class="sm:text-5xl text-4xl dark:text-white !leading-normal relative font-medium">
            I'm <span class="text-primary">{{ $homes->name }}</span> as a<br /> Junior Developer
          </h1>
        ...
        <div class="flex justify-center md:justify-start">
          <img
            src="{{ asset('storage/' . $homes->image) }}"
            class="w-2/3 mx-auto md:w-full max-w-96 md:mt-0 mt-5"
            alt="Ibnu"
          />
        </div>
      </div>
    ...
    <!-- About and Skills -->
    <section id="about-skills" class="max-w-screen-xl px-4 lg:px-8 mx-auto mb-8 flex flex-col lg:flex-row place-items-center items-start justify-between space-y-10 lg:space-y-0 lg:space-x-200">
      <!-- Deskripsi About di kiri -->
      <div class="w-full lg:w-5/12 ">
        <div class="text-center md:text-left mb-8">
          <h3 class="text-2xl font-semibold px-20">About Me</h3>
          <p class="mt-8 text-gray-500 px-20">
            Halo, saya Ibnu Nabil Nur Ihsan, lahir di Wonogiri pada tanggal 14 November. Saat ini, saya sedang menempuh pendidikan di SMK Negeri 1 Ciomas dengan jurusan PPLG (Pengembangan Perangkat Lunak dan Game).
          </p>
          <div class="flex items-center md:justify-start justify-center dark:text-gray-200 text-gray-600 gap-6 mt-9 px-20">
    ...
    <!-- Projects -->
      <section id="projects" class="container max-h-screen flex-center">
        <div class="text-center text-balance">
            ...
            <p class="px-2 mt-3 text-gray-500">
              Kumpulan aplikasi dan situs web yang saya bangun untuk mengasah keterampilan pemrograman saya, dengan menggunakan teknologi terbaru.
            </p>
                ...
                @foreach($projects as $project)
                    <div class="group hover:!grayscale-0 hover:duration-1000 bg-white shadow-lg rounded-lg overflow-hidden mx-2 my-8">
                        <a href="{{ $project->link }}" target="_blank">
                            <img class="rounded-t-md w-full h-40 object-cover" src="{{ asset('storage/' . $project->image) }}" alt="{{ $project->name }}" />
                        </a>
                        <div class="p-4">
    ...
    <section id="certificate" class="container max-h-screen flex-center">
      <div class="text-center text-balance">
          ...
          <p class="px-2 mt-3 text-gray-500">
            Berikut adalah koleksi sertifikat yang saya peroleh sebagai bukti keahlian dan dedikasi saya dalam mengembangkan diri.
              ...
              @foreach($certificates as $certificate)
                  <div class="group hover:!grayscale-0 hover:duration-1000 bg-white shadow-lg rounded-lg overflow-hidden mx-2 my-8">
                      ...
                      <div class="p-4">
                          ...
                          <div class="mt-4 text-center">
                              <a href="{{ asset('storage/' . $certificate->file) }}" target="_blank" class="text-blue-500 hover:underline">View Certificate</a>
                          </div>
                      </div>
                  </div>
              @endforeach
      ...
      <div class="pb-10">
        ...
        >
          ...
          >
            ...
            <form
              class="*:flex *:flex-col *:gap-1 mt-5 md:w-2/3 w-full"
              method="POST"
